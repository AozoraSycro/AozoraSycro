...
<tr>
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li>มหาวิทยาลัยหัวเฉียวเฉลิมพระเกียรติ (2566 - ปัจจุบัน)</li>
        <li><i>ปัจจุบันกำลังศึกษาอยู่ชั้นปีที่ 3</i></li>
      </ul>
    </td>
...
### 💼 ประสบการณ์และความเป็นผู้นำ (Experience)

<table width="100%">
  <tr>
    <td width="100%">
      <b>ผู้ช่วยสอน (Teaching Assistant - Corporate Technical Training)</b><br>
      <i>มหาวิทยาลัยหัวเฉียวเฉลิมพระเกียรติ</i><br>
      เป็นผู้ช่วยคณาจารย์ในการจัดอบรมเชิงปฏิบัติการ (Workshop) ด้านเทคโนโลยีให้กับองค์กรระดับประเทศ โดยมีหน้าที่ให้คำแนะนำ ดูแลการปฏิบัติงานจริง และแก้ปัญหาทางเทคนิคให้กับผู้เข้าอบรมวัยทำงาน<br><br>
      <b>ผลงานหลัก:</b>
      <ul>
        <li><b>บริษัท ไปรษณีย์ไทย จำกัด:</b> ช่วยสอนในหลักสูตร <i>"Next-Gen Logistics: Real-Time Tracking and Asset Intelligence with IoT Gateway & Printable RFID"</i></li>
        <li><b>กองบัญชาการกองทัพไทย:</b> ให้คำแนะนำในหลักสูตร <i>Business Process Model and Notation (BPMN)</i> สำหรับการออกแบบระบบ และ <i>การพัฒนา Dashboard</i> เพื่อการวิเคราะห์ข้อมูล</li>
      </ul>
    </td>
  </tr>
</table>
